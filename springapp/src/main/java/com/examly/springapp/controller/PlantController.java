...
public class PlantController {
    ...
    public ResponseEntity<List<Plant>> generateCarePlan(@RequestParam String method){
        return new ResponseEntity<>(plantService.generateCarePlan(method),HttpStatus.OK);
    }
}
